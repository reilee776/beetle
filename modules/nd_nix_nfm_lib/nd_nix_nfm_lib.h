...
#define IOCTL_GET_LOG                   _IOR(ND_IOCTL_MAGIC, 41,        char [MAX_STRING_LENGTH*256])

#define IOCTL_ADD_BYPASS_RULE	_IOR(ND_IOCTL_MAGIC, 50, struct cmd_bypass_rule_data)
#define IOCTL_DEL_BYPASS_RULE	_IOR(ND_IOCTL_MAGIC, 51, struct cmd_bypass_rule_data)
#define IOCTL_GET_BYPASS_RULES	_IOWR(ND_IOCTL_MAGIC, 52,  char [MAX_STRING_LENGTH])
#define IOCTL_RESET_BYPASS_RULES _IO(ND_IOCTL_MAGIC,53)
 ...
 *
 */
int sdk_add_NdNixNfmDrv_bypass_policy (struct cmd_bypass_rule_data* bypass );

/*
 *
 */
int sdk_del_NdNixNfmDrv_bypass_policy (struct cmd_bypass_rule_data* bypass );

/*
 *
 */
int sdk_get_NdNixNfmDrv_bypass_policy (char *data );

/*
 *
 */
int sdk_reset_NdNixNfmDrv_bypass_policy (void );
